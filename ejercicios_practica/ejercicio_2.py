...
# print(....)
print ("Los dos números para trabajar son:", numero_1, "y", numero_2, "." )
...
# Multiplicación
multiplic = numero_1 * numero_2 
print ("El resultado de multiplicar", numero_1, "y", numero_2, "es:", multiplic)
